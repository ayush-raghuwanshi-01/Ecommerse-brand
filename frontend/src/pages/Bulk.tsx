...
export default function BulkPage() {
  ...
  return (
    <main className="page">
      <Seo
        title="Bulk orders — Black House"
        description="Uniforms and bulk outerwear production for teams and enterprises."
      />
      <div className="page-head">
        ...
        <p className="dim">
          Hotels, studios, enterprises — small-batch production runs with the same cloth and finish as our
          retail line.
        </p>
      </div>
      ...
      {sent ? (
        <p className="ok banner">
          ✓ Thank you — your enquiry is with our sales team. We reply within one working day.
        </p>
      ) : (
        <form className="panel narrow" onSubmit={submit}>
          ...
          <label>
            ...
            <input
              ...
              onChange={(e) => setForm({ ...form, estimated_qty: e.target.value.replace(/\D/g, '') })}
            />
          </label>
          <label>
            Message
