...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "discount_type",
            sa.Enum("fixed", "percentage", name="coupontype", native_enum=False, length=40),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("pending", "sent", "failed", name="notificationstatus", native_enum=False, length=40),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("customer", "staff", "manager", "admin", name="userrole", native_enum=False, length=40),
            nullable=False,
        ),
        sa.Column("is_active", sa.Boolean(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "address_type",
            sa.Enum("home", "work", "other", name="addresstype", native_enum=False, length=40),
            nullable=False,
        ),
        sa.Column("full_name", sa.String(length=160), nullable=False),
        sa.Column("phone", sa.String(length=20), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "payment_method",
            sa.Enum("razorpay", "upi", "cod", name="paymentmethod", native_enum=False, length=40),
            nullable=False,
        ),
        sa.Column(
            "payment_status",
    ...
    op.create_table(
        ...
        sa.Column(
            "provider",
            sa.Enum("razorpay", "mock", name="paymentprovider", native_enum=False, length=40),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "size",
            sa.Enum("XS", "S", "M", "L", "XL", "XXL", name="variantsize", native_enum=False, length=40),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("active", "notified", "cancelled", name="restockstatus", native_enum=False, length=40),
            nullable=False,
        ),
    ...
    with op.batch_alter_table("restock_subscriptions", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_restock_subscriptions_customer_id"), ["customer_id"], unique=False
        )
